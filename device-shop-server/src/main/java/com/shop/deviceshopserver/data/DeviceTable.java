...
public class DeviceTable {
    ...
    public DeviceTable(){
        ...
        dispositivi.add(new Device("8 GB di SDRAM DDR4-2400", "RAM", "Portatile", 35));
    ...
    public List<Device> getTipologyList(String key){
        return dispositivi.stream().filter(a -> a.tipologia().equals(key)).toList();
    }

    public List<Device> getCompatibilityList(String key){
        return dispositivi.stream().filter(a -> a.tipologia().equals(key)).toList();
    }
